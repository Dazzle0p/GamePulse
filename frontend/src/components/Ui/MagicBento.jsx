...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-2 p-3 max-w-8xl select-none relative"
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="card__content flex flex-col relative text-white mt-auto">
                    <h3 className="card__title font-normal text-lg mb-1">
                      {game.title}
                    </h3>
                    <p className="card__description text-sm leading-5 opacity-90 mb-3">
                      {game.description}
                    </p>
                    <button className="mt-auto bg-orange-500 hover:bg-orange-600 transition px-4 py-2 rounded-lg text-white text-sm font-medium">
                      {game.cta || "Learn More"}
                    </button>
                  </div>
                </div>
